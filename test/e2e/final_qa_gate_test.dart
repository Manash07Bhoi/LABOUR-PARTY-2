...
void main() {
  ...
  test('GATE 1: Labour Integrity & Edit Preservation', () async {
    final work = Work(id: 'w_24_may', date: '24 May 2026', session: 'Morning', workType: 'Sand', place: '', createdAt: DateTime.now(), updatedAt: DateTime.now());
    final trip = Trip(id: 't1', workId: 'w_24_may', tripNumber: 1, tractor: 'T1', driverName: 'D1', createdAt: DateTime.now());
    ...
    final tl1 = TripLabour(id: 'tl1', tripId: 't1', labourId: 'l1', isPresent: true);
    final tl2 = TripLabour(id: 'tl2', tripId: 't1', labourId: 'l2', isPresent: true);
    final tl3 = TripLabour(id: 'tl3', tripId: 't1', labourId: 'l3', isPresent: true);

    bloc.add(SaveFullWorkTripEvent(work: work, trip: trip, tripLabours: [tl1, tl2, tl3], labours: [l1, l2, l3]));
  ...
  test('GATE 2: Attendance Toggle & Negative Button', () async {
    ...
    final tl1 = TripLabour(id: 'tl1', tripId: 't1', labourId: 'l1', isPresent: true);
    final tl2 = TripLabour(id: 'tl2', tripId: 't1', labourId: 'l2', isPresent: true);
    bloc.add(SaveFullWorkTripEvent(work: work, trip: trip, tripLabours: [tl1, tl2], labours: [l1, l2]));
    await Future.delayed(const Duration(milliseconds: 100));

    // Negative button: Edit trip, remove l2, and mark l1 absent
    final tl1_edit = TripLabour(id: 'tl1', tripId: 't1', labourId: 'l1', isPresent: false);
    bloc.add(SaveFullWorkTripEvent(work: work, trip: trip, tripLabours: [tl1_edit], labours: [l1]));
    await Future.delayed(const Duration(milliseconds: 100));
  ...
  test('GATE 3: Date Isolation', () async {
    final work24 = Work(id: 'work_24_May_2026_Morning', date: '24 May 2026', session: 'Morning', workType: 'Sand', place: '', createdAt: DateTime.now(), updatedAt: DateTime.now());
    final work25 = Work(id: 'work_25_May_2026_Morning', date: '25 May 2026', session: 'Morning', workType: 'Sand', place: '', createdAt: DateTime.now(), updatedAt: DateTime.now());

    final trip24 = Trip(id: 't1', workId: work24.id, tripNumber: 1, tractor: 'T1', driverName: 'D1', createdAt: DateTime.now());
    final trip25 = Trip(id: 't2', workId: work25.id, tripNumber: 1, tractor: 'T1', driverName: 'D1', createdAt: DateTime.now());

    bloc.add(SaveFullWorkTripEvent(work: work24, trip: trip24, tripLabours: [], labours: []));
    await Future.delayed(const Duration(milliseconds: 100));

    bloc.add(SaveFullWorkTripEvent(work: work25, trip: trip25, tripLabours: [], labours: []));
    await Future.delayed(const Duration(milliseconds: 100));
